<template>
	<view>
		...
		<view class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30">
			...
			<view class="u-m-l-10 u-p-10" @click="login"><u-icon name="arrow-right" color="#969799" size="28"></u-icon></view>
		</view>

		<view class="u-m-t-20">
			<u-cell-group><u-cell-item icon="rmb-circle" title="支付" @click="zhifu"></u-cell-item></u-cell-group>
		</view>
...
export default {
	...
	methods: {
		async zhifu() {
			console.log(this.$http, '支付');
			try {
				const res = await this.$http.login({ wd: 'uni-app' });
				console.log(res);
			} catch (err) {
				console.log(err);
			}
